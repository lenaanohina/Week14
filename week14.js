...
const myInformation = ["Елена", 27, "мая", "Близнецы"];
...
let cities = ["Санкт-Петербург", "Москва", "Екатеринбург"];
let russianCities = [...cities, "Казань", "Нижний Новгород"];
